...
interface JogoCardProps {
  jogo: any;
  index: number;
  onEdit: (jogo: any) => void;
  onDelete: (jogo: any) => void;
  onConfirmations: (jogo: any) => void;
  onRegister: (jogo: any) => void;
}

const JogoCard: React.FC<JogoCardProps> = ({
  jogo,
  index,
  onEdit,
  onDelete,
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div className="flex flex-col items-center space-y-1">
              ...
              <p className="text-sm font-medium text-gray-900">
                {jogo.presencas.filter((p: any) => p.confirmou).length}/{jogo.presencas.length}
              </p>
